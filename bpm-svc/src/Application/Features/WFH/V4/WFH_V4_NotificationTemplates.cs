...
/// <summary>
/// Pure render functions for the three WFH V4 notification templates
...
/// </summary>
public static class WFH_V4_NotificationTemplates
{
    ...
    /// "居家辦公 — 30 天（2026/07/01 ~ 2026/07/30）".
    /// </summary>
    public static string BuildSummary(WFH_V4_Case c)
