...
/// <summary>
/// Pure render functions for the three WFH V2 notification templates
...
/// </summary>
public static class WFH_V2_NotificationTemplates
{
    ...
    /// "居家辦公 — 15 天（2026/07/01 ~ 2026/07/15）".
    /// </summary>
    public static string BuildSummary(WFH_V2_Case c)
