...
/// <summary>
/// Persistent case for the WFH (居家辦公申請) V3 flow. Holds the
...
/// <c>approval_senior</c> (only when <see cref="Days"/> &gt;= 30, routed
...
public class WFH_V3_Case
{
    ...
    // Workflow state
    public WFH_V3_CaseStatus Status { get; set; } = WFH_V3_CaseStatus.PendingManager;
