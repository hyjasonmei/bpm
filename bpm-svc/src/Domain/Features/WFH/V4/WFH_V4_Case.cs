...
/// <summary>
/// Persistent case for the WFH (居家辦公申請) V4 flow. Holds the
...
/// <c>approval_senior</c> (only when <see cref="Days"/> &gt;= 60, routed
...
public class WFH_V4_Case
{
    ...
    // Workflow state
    public WFH_V4_CaseStatus Status { get; set; } = WFH_V4_CaseStatus.PendingManager;
