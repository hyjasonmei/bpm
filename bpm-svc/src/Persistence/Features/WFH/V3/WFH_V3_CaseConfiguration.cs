...
public sealed class WFH_V3_CaseConfiguration : IEntityTypeConfiguration<WFH_V3_Case>
{
    public void Configure(EntityTypeBuilder<WFH_V3_Case> b)
    {
        b.ToTable("WFH_V3_case");
        b.HasKey(c => c.Id);
