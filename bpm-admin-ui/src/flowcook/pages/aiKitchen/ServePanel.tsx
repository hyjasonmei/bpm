...
import { CheckCircle2, Loader2, Rocket, ShieldCheck, Undo2 } from 'lucide-react'
import { cn } from '@/lib/cn'
import {
  getFlow, approveFlow, publishFlow, unpublishFlow, type FlowState,
...
export function ServePanel({
  ...
  const hint = useMemo(() => {
    switch (state) {
      ...
      case 'Approved':  return '尚未上線。按 Publish 讓它在這環境的 launcher 出現。'
