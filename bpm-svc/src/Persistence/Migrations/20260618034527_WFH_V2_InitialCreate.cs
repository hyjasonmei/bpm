...
{
    /// <inheritdoc />
    public partial class WFH_V2_InitialCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WFH_V2_case", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_WFH_V2_case_CurrentAssigneeUserId",
                table: "WFH_V2_case",
                column: "CurrentAssigneeUserId");

            migrationBuilder.CreateIndex(
                name: "IX_WFH_V2_case_Status_LastActivityAt",
                table: "WFH_V2_case",
                columns: new[] { "Status", "LastActivityAt" });

            migrationBuilder.CreateIndex(
                name: "IX_WFH_V2_case_SubmitterUserId",
                table: "WFH_V2_case",
