import type { WFH_V1_Status, WFH_V1_SubmitPayload } from './WFH_V1_types'

export function emptyPayload(): WFH_V1_SubmitPayload {
  return { applyDate: '', start: '', end: '', reason: '', attachmentFileId: null }
}

/** Senior approval (上級主管) kicks in above this many consecutive days (spec gateway_days). */
export const DAYS_GATE_THRESHOLD = 7
 ...
 * `WFH_V1_WfhService.ComputeConsecutiveDays`; the server recomputes and
...
export function zhStatus(s: WFH_V1_Status): string {
  switch (s) {
