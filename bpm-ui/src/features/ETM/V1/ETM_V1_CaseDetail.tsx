...
export function ETM_V1_CaseDetail({ caseId }: CaseDetailProps) {
  ...
  const isCurrentAssignee = !!data && !!viewerUserId &&
    (data.currentAssigneeUserId === viewerUserId ||
      (!!data.currentAssigneeUserId && delegatedFor.includes(data.currentAssigneeUserId)))
