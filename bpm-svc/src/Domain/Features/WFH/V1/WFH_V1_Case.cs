...
/// <summary>
/// Persistent case for the WFH (居家辦公申請) V1 flow. Holds the
...
/// <c>approval_senior</c> (only when <see cref="Days"/> &gt; 7, routed
...
public class WFH_V1_Case
{
    ...
    // Workflow state
    public WFH_V1_CaseStatus Status { get; set; } = WFH_V1_CaseStatus.PendingManager;
