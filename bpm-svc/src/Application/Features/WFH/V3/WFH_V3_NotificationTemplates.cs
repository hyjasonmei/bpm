...
/// <summary>
/// Pure render functions for the three WFH V3 notification templates
...
/// </summary>
public static class WFH_V3_NotificationTemplates
{
    ...
    /// </summary>
    public static string BuildSummary(WFH_V3_Case c)
