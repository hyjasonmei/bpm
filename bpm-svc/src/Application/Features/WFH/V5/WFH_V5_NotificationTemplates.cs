...
/// <summary>
/// Pure render functions for the three WFH V5 notification templates
...
/// </summary>
public static class WFH_V5_NotificationTemplates
{
    ...
    /// </summary>
    public static string BuildSummary(WFH_V5_Case c)
