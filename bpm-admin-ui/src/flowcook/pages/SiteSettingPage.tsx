import { Database, FolderTree, Palette, Rocket, RotateCcw } from 'lucide-react'
...
import { DeployTab } from './sitesetting/DeployTab'
...
const TABS = [
  ...
  { path: '/site-setting/deploy',         label: 'Deploy',         icon: Rocket },
