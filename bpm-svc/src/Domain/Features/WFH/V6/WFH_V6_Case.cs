...
/// <summary>
/// Persistent case for the WFH (居家辦公申請) V6 flow. Holds the
...
/// <c>approval_senior</c> (only when <see cref="Days"/> &gt;= 100, routed
...
public class WFH_V6_Case
{
    ...
    // Workflow state
    public WFH_V6_CaseStatus Status { get; set; } = WFH_V6_CaseStatus.PendingManager;
