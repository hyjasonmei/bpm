...
/// <summary>
/// Persistent case for the WFH (居家辦公申請) V5 flow. Holds the
...
/// <c>approval_senior</c> (only when <see cref="Days"/> &gt;= 90, routed
...
public class WFH_V5_Case
{
    ...
    // Workflow state
    public WFH_V5_CaseStatus Status { get; set; } = WFH_V5_CaseStatus.PendingManager;
